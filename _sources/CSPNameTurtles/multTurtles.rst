...
.. parsonsprob:: 5_4_2_JandT
   ...
   The following program has one turtle, "jamal", draw a capital L in blue and then another, "tina", draw a line to the west in orange as shown below.  The program should do all set-up, have "jamal" draw the L, and then have "tina" draw the line.

   .. image:: ../../_static/TwoTurtles1N.png
       :width: 150px
       :align: center

   Drag the blocks of statements from the left column to the right column and put them in the right order.  Then click on 'Check' to see if you are right. You will be told if any of the lines are in the wrong order or are the wrong blocks.
   -----
   from turtle import *
   wn = Screen()
   =====    	
...
.. parsonsprob:: 5_4_3_JandT2
   ...
   .. image:: ../../_static/TwoTurtlesLN.png
       :width: 150px
       :align: center
