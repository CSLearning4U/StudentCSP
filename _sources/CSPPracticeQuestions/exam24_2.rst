...
.. timed:: ch24t2
    ...
    .. mchoice:: e24_2_7_v2
       ...
       :feedback_d: Correct. All three of these scenarios occur.
       ...
       ::
        ...
        I.   “ODD” is printed int(n/2) times if n is even
        II.  “ODD” is printed int((n + 1)/2) times if n is odd
        III. “EVEN” is printed int((n - 1)/2) times if n is odd
